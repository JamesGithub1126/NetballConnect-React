...
import { directCompetitionCreation as competition_inputs } from '../fixtures/directCompetitionCreation';
...
export class DirectCompetitionCreation {
  readonly page: Page;
  ...
  private readonly registrationInviteesDirect: Locator;
  ...
  constructor(page: Page) {
    ...
    this.registrationInviteesDirect = page.getByTestId(AppUniqueId.REGISTRATION_INVITEES_DIRECT);
  ...
  async competitionCreation(scenario: any) {
    ...
    this.competitionDetails = await competition_inputs.direct_Competition;
    ...
    await this.registrationInviteesDirect.click();
