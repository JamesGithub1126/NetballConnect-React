...
const AppConstants = {
  ...
  extraTimeIfDraw2: 'What happens if the extra time is a draw?',
  ...
  netSetGo: 'Introduction to Basketball',
  dobFrom: 'DOB From',
  dobTo: 'DOB To',
  ...
  selectUmpire3Organisation: 'Select Referee 3 Organisation',
  selectUmpire4Organisation: 'Select Referee 4 Organisation',
  selectUmpireCoachOrganisation: 'Select Referee Coach Organisation',
  ...
  record: 'Record',
  report: 'Report',
  attendance_record_report: 'Active Player List Recording and Reporting',
  scoring: 'Scoring',
  ...
  teamAttendance: 'Active Players Attendance',
  newsList: 'News List',
  ...
  attendanceRecordingTime: 'Active Player List Recording Time',
  _days: 'Days',
  _hours: 'Hours',
  _minutes: 'Minutes',
  ...
  squadSelection: 'Team List Selection',
  ...
  umpire1Rate: 'Referee 1 Rate (inc GST)',
  umpire2Rate: 'Referee 2 Rate (inc GST)',
  umpire3Rate: 'Referee 3 Rate (inc GST)',
  umpire4Rate: '4th Official Rate (inc GST)',
  umpireResRate: 'Ref. Reserve Rate (inc GST)',
  umpireCoachRate: 'Ref. Coach Rate (inc GST)',
  ...
  deRegistrationHelpMsg:
    'What is de-registration? I am leaving Basketball and no longer want to participate in Basketball. I have not taken the court for training, grading or competition games.',
  transferHelpMsg:
    'What is a transfer? I am wanting to move to another Basketball Club or Association for the upcoming season.',
  deRegistrationOption1:
    "I am over committed with other activities and can't fit in time for Basketball",
  deRegistrationOption2: 'I have been injured or for other health reason (not Basketball related)',
  deRegistrationOption3: 'Decided not to participate in Basketball',
  deRegistrationOption4: 'Moving to a different geographical area',
  transferOption1: 'Moving to another Basketball Club or Association for the upcoming season',
  ...
  M: 'M',
  appContextual:
    'App - Communication will be saved and available on the News Page of the Basketball Connect App.',
  jersey: 'Jersey#',
  ...
  doNotSendEmail:
    'Receive Basketball Connect email communications from the club / association / state',
  marketingOptIn:
    'Receive special offers from our sponsors including FREE and/or discounted items, prize giveaways news etc via Basketball Connect email communications',
  ...
  reselectAtCourtUmpiresMsg2:
    'You will need to re-select them from the dropdowns below to ensure they are accurately reflected in the reports.',
  ...
  attendanceMaximumNumber: 'Active Player List Maximum Number',
  squadMaximumNumber: 'Team List Maximum Number',
  ...
  goalsAdjustment: 'Points Adjustment',
  addOfficials: 'Add Referee / Officials',
  editOfficials: 'Edit Referee / Officials',
  ...
  userRoles: [
    ...
    },
    {
      ...
      roleId: RegistrationUserRoles.Other,
    },
  ],
  goalStatistics: 'Points Statistics',
  menuGoals: 'Points',
};
